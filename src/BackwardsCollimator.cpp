...
static Ref_t create_detector(Detector& det, xml_h e, SensitiveDetector sens)  {
  ...
  Material   m_Steel   = det.material("stainless_steel");
  ...
  // -----------------------------
  // final placement
  auto pv_assembly = det.pickMotherVolume(sdet).placeVolume(assembly,Transform3D(RotationZYX( 0.0, 0.0 , 0.0), Position(0.0, 0.0, zOff)));
