...
static Ref_t create_detector(Detector& det, xml_h e, SensitiveDetector sens)  {
  ...
  double innerD1     = IP_pipe_c.attr<double>(_Unicode(innerD1));
  double innerD2     = IP_pipe_c.attr<double>(_Unicode(innerD2));
  ...
  ConeSegment tube_tube(length/2.0,  innerD1/2.0, innerD1/2.0+thickness, innerD2/2.0, innerD2/2.0+thickness);
