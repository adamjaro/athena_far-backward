...
static Ref_t createDetector(Detector& lccdd, xml_h e, SensitiveDetector /*sens*/) {
  ...
  Info("BackwardsTagWin", "zB: %f", zB);
  Info("BackwardsTagWin", "xB: %f", xB);
  Info("BackwardsTagWin", "zT: %f", zT);
  Info("BackwardsTagWin", "xT: %f", xT);
  Info("BackwardsTagWin", "zTB: %f", zTB);
  Info("BackwardsTagWin", "xTB: %f", xTB);
